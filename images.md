...
4b196525bd3c   3 weeks ago   CMD ["nginx" "-g" "daemon off;"]                0B        buildkit.dockerfile.v0
...
<missing>      3 weeks ago   RUN /bin/sh -c set -x     && groupadd --syst…   99.8MB    buildkit.dockerfile.v0
...
<missing>      3 weeks ago   /bin/sh -c #(nop) ADD file:702193928cded0bce…   97.1MB
```